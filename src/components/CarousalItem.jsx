  ...
  return (
    <div className='sm:w-[180px]  h-fit flex flex-col-reverse   items-center xl:shrink-0'>
       <div className='h-[6px]  sm:w-[50%] w-[100px]  bg-[#DBE0E5] rounded-xl mt-2'></div>
         <h1 className='xl:text-4xl text-2xl font-oswald text-[#00357B] font-semibold'>{h}</h1>
         <h1 className='text-[#00357B] xl:text-lg  text-center font-poppins font-medium'>{p}</h1>
