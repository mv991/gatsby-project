      ...
      <div className="w-full min-h-screen h-fit ">
        <div className="flex md:flex-row flex-col min-h-screen h-fit items-center md:pt-0  sm:pt-[230px] pt-[150px]  lg:w-[80%] w-[90%] mx-auto  lg:max-w-[1600px]">
          <div className="md:w-1/2 w-full flex flex-col  h-1/2 ">
            ...
            <p className="text-white font-semibold text-2xl mt-4 md:w-[400px] 2xl:w-[490px] max-w-full font-poppins">
              1, 2 & 3 Bedrooms Seaside Apartments in Dubai Maritime City
            </p>
            <div className="h-fit w-[360px] card p-3 mt-[50px] font-[200] border-l-2 border-[#17ABFF] text-white max-w-[90%] font-poppins">
              Rental Returns of <span className="font-[400]">UPTO 11%**</span>
            </div>
            <div className="h-fit w-[360px] card p-3 mt-3 font-[200] border-l-2 border-[#17ABFF] text-white font-poppins max-w-[90%]">
